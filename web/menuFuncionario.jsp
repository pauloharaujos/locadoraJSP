			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="barra-navegacao">
				  <ul class="nav navbar-nav navbar-right">
				    ...
				    <li class="dropdown">
				    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
				    <span class="glyphicon glyphicon-calendar"></span> Locação <span class="caret"></span>
				    </a>
				    <ul class="dropdown-menu">
				   ...
				   <li class="dropdown">
				    ...
				    <ul class="dropdown-menu">
				     ...
				     <li> <a href="alterarAtor.jsp"><span class="glyphicon glyphicon-refresh"></span> Alterar Ator</a> </li>
				     <li> <a href="excluirAtor.jsp"> <span class="glyphicon glyphicon-remove"></span> Excluir Ator</a> </li>
				    </ul>
				    </li>
				   ...
				   <li class="dropdown">
				    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
				    <span class="glyphicon glyphicon-cog"></span> Olá Paulo <span class="caret"></span>
				    </a>
				    <ul class="dropdown-menu">
