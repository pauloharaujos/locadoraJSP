...
<head>
	...
	<title>Consultar Alteracao Diretor</title>
	<!-- Bootstrap -->
...
<body>
	...
	<div class="container">
        ...
        <div class="col-md-12 jumbotron">
			...
			<h2 align="center"> CONSULTAR DIRETOR PARA ALTERAÇÃO</h2>
              <br><br>             
                ...
                <tbody data-link='row' class='rowlink'>
                 <%
                      ...
                      while(i.hasNext()){
                        ...
                        int id = t1.getId(); 
//                       
                            out.println("<form class='form-horizontal' method='POST' action='alterarDiretor.jsp'>");
                            out.println("<tr>");
                            out.println("<td>"+ t1.getNome() +"</td>"                                                          
                                    + " <td> <button type='submit' name='operacao' value='alterarDiretor' class='btn btn-default'  > Alterar  </button> ");
