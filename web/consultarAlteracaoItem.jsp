...
<head>
	...
	<title>Consultar Item Para Alteração</title>
	<!-- Bootstrap -->
...
<body>
	...
	<div class="container">
        ...
        <div class="col-md-12 jumbotron">
			...
			<h2 align="center"> CONSULTAR ITEM PARA ALTERAÇÃO</h2>
              <br><br>             
                ...
                <tbody data-link='row' class='rowlink'>
                 <%
                      ...
                      while(i.hasNext()){
                        Item t1 = (Item) i.next();
                        int id = t1.getId(); 
                        out.println("<form class='form-horizontal' method='POST' action='alterarItem.jsp'>");
                        out.println("<tr>");
                        out.println("<td>"+ t1.getTitulo() +"</td>"
                                    + "<td>"+t1.getTipoItem()+"</td>"
                                    + "<td>"+t1.getNumSerie()+"</td>"
                                    + "<td>"+t1.getDtAquisicao()+"</td>"                                                                  
                                    + " <td> <button type='submit' name='operacao' value='alterarItem' class='btn btn-default'  > Alterar  </button> ");
