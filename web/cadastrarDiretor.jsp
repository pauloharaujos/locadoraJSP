...
<body>
	...
	<div class="container">
        ...
        <div class="col-md-12 jumbotron">
			<h2 align="center"> CADASTRO DE DIRETOR</h2>		
            <form class="form-horizontal" method="POST" action="ServletCadastrarDiretor">
              <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nome</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="nome" name="nome" placeholder="Joao Almeida">
                </div>
              </div>

              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <button type="submit" name="operacao" value="incluirDiretor" class="btn btn-default">Cadastrar</button>
                </div>
              </div>
              </form>
    		</div>
