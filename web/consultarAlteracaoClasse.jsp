...
<head>
	...
	<title>Consultar Alteracao Classe</title>
	<!-- Bootstrap -->
...
<body>
	...
	<div class="container">
        ...
        <div class="col-md-12 jumbotron">
		   ...
		   <h2 align="center"> CONSULTAR CLASSE PARA ALTERAÇÃO</h2>
              <br><br>                           
                ...
                <tbody data-link='row' class='rowlink'>
                 <%
                      ...
                      while(i.hasNext()){
                        ...
                        int id = t1.getId(); 
//                       
                            out.println("<form class='form-horizontal' method='POST' action='alterarClasse.jsp'>");
                            out.println("<tr>");
                            out.println("<td>"+ t1.getNome() +"</td>"                                                          
                                    + " <td> <button type='submit' name='operacao' value='alterarClasse' class='btn btn-default'  > Alterar  </button> ");
