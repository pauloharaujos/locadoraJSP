...
<head>
	...
	<title>Consultar Cliente Para Alteração</title>
	<!-- Bootstrap -->
...
<body>
	...
	<div class="container">
        ...
        <div class="col-md-12 jumbotron">
			...
			<h2 align="center"> CONSULTAR CLIENTE PARA ALTERAÇÃO</h2>
              <br><br>             
                      ...
                      while(i.hasNext()){
                        ...
                        if( c1 instanceof Dependente ){
                          Dependente d1 = (Dependente) c1;
                            ...
                            out.println("<form class='form-horizontal' method='POST' action='alterarDependente.jsp'>");
                            out.println("<tr>");
                            out.println("<td>"+ d1.getNome() +"</td>"
                                    ...
                                    + "<td>"+d1.getSocio()+"</td>"
                                    + " <td> <button type='submit' name='operacao' value='alterarDependente' class='btn btn-default'  > Alterar Dependente </button> ");
                            ...
                            out.println("<form class='form-horizontal' method='POST' action='alterarSocio.jsp'>");
                            out.println("<tr>");
                            out.println("<td>"+ s1.getNome() +"</td>"
                                        ...
                                        + "<td>"+s1.getTel()+"</td>"
                                        + " <td> <button type='submit' name='operacao' value='alterarSocio' class='btn btn-default'  > Alterar Socio </button> ");
                            out.println("<input type='hidden' id='id' name='id' value ='" + s1.getNumIncricao() + "'>");
                            out.println("<input type='hidden' id='nome' name='nome' value ='"+ s1.getNome()+"'>");
                            out.println("<input type='hidden' id='sexo' name='sexo' value ='"+ s1.getSexo()+"'>");
                            out.println("<input type='hidden' id='dtNasc' name='dtNasc' value ='"+ s1.getDtNascimento() +"'>");
                            out.println("<input type='hidden' id='ativo' name='ativo' value ='"+ s1.getEstahAtivo()+"'>");   
                            out.println("<input type='hidden' id='cpf' name='cpf' value ='"+ s1.getCpf()+"'>"); 
                            out.println("<input type='hidden' id='endereco' name='endereco' value ='"+ s1.getEndereco()+"'>"); 
                            out.println("<input type='hidden' id='telefone' name='telefone' value ='"+ s1.getTel()+"'>"); 
                            out.println("</tr>");
                            out.println("</form>");    
                        }
