...
<head>
	...
	<title>Consultar Exclusao Classe</title>
	<!-- Bootstrap -->
...
<body>
	...
	<div class="container">
        ...
        <div class="col-md-12 jumbotron">
			...
			<h2 align="center"> CONSULTAR CLASSE PARA EXCLUSAO</h2>
              <br><br>             
              ...
              <table id="myTable" class="table table-striped table-bordered table-hover">
                ...
                <tbody data-link='row' class='rowlink'>
                 <%
                      ...
                      while(i.hasNext()){
                        Classe t1 = (Classe) i.next();
                        int id = t1.getId(); 
//                       
                            out.println("<form class='form-horizontal' method='POST' action='ServletCadastrarClasse'>");
                            out.println("<tr>");
                            out.println("<td>"+ t1.getNome() +"</td>"                                                          
                                    + " <td> <button type='submit' name='operacao' value='excluirClasse' class='btn btn-default'  > Excluir  </button> ");
